                                            ...
                                            <div className="block-content__box">
                                                <div className="block-content__text">
                                                    ...
                                                    <p className="text text--opacity">
                                                        Limitations of our liability for the use of the website
                                                    </p>
                                                    <p className="text text--opacity text--grey">
                                        ...
                                        <div className="block-content__wrapper">
                                            <div className="block-content__box">
                                                <div className="block-content__text">
                                                    ...
                                                    <p className="text text--opacity">
                                                        The information provided by Accurate Machinery, Inc. ("we,"
                                                        "us," or "our" on giuliano-usa.com) is for general informational
                                                        purposes only. All information on is provided in good faith,
                                                    ...
                                                    <p className="text text--opacity">
                                                        The Site may contain or you may be sent through to other
