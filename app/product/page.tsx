                                            ...
                                            <div className="block-content__box">
                                                <div className="block-content__text">
                                                    ...
                                                    <p className="text text--opacity">
                                                        ...
                                                        customization options available. The combination of lightweight
                                                        materials and corrosion-resistant stainless.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="block-img">
                                        ...
                                        <div className="swiper block-slider">
                                            <div className="swiper-wrapper">
                                                <div className="swiper-slide block-slider__item">
                                                    <Image unoptimized={true} alt="Logo" width={0} height={0} src="/img/slider/1.webp" />
                                                </div>
                                            </div>
                                            <div className="block-slider__nav">
                                                <a href="#" className="block-slider__button block-slider__button--next">
                                                    <svg className="icon">
                                                        
                                                    </svg>
                                                </a>
                                                <div className="block-slider__pagination"></div>
                                                <a href="#" className="block-slider__button block-slider__button--prev">
                                                    <svg className="icon">
