                                            ...
                                            <div className="block-content__box">
                                                <div className="block-content__text">
                                                    ...
                                                    <p className="text text--opacity">
                                                        How and why we might collect, store, use, and/or share your
                                                        information.
                                                    </p>
                                                    <p className="text text--opacity">
                                                        This privacy notice for Accurate Machinery, Inc. Company we, us,
                                                        or our, describes how and why we might collect, store, use,
                                                        and/or share your information when you use our services.
                                                        Services, such as when you: Visit our website https:// or any
                                                        website of ours that links to this privacy notice. Engage with
                                                        ...
                                                        contact us at accu@accumachinery.com.
                                                    </p>
                                                    <p className="text text--grey text--opacity">
                                                        Last updated Jule 19, 2025
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="block-content">
                                        <div className="block-content__wrapper">
                                            <div className="block-content__box">
                                                <div className="block-content__text">
                                                    <h2 className="title title--base">
                                                        Сookies and similar technologies
                                                    </h2>
                                                    <p className="text text--opacity">
                                                        Most Web browsers are set to accept cookies by default. If you
                                                        prefer, you can usually choose to set your browser to remove
                                                    ...
                                                    <h2 className="title title--base">
                                                        Сontrols for do-not-track features
                                                    </h2>
                                                    <p className="text text--opacity">
                                                        ...
                                                        At this stage no uniform technology standard for and
                                                        implementing DNT signals has been. As such, we do not currently
